    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        ...
        __Vscope_I2C_slave__the_piso.varInsert(__Vfinal,"counter_plus_1", &(TOP.I2C_slave__DOT__the_piso__DOT__counter_plus_1), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,1 ,3,0);
        ...
        __Vscope_I2C_slave__the_piso.varInsert(__Vfinal,"out", &(TOP.I2C_slave__DOT__the_piso__DOT__out), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
        ...
        __Vscope_I2C_slave__the_piso.varInsert(__Vfinal,"shift", &(TOP.I2C_slave__DOT__the_piso__DOT__shift), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RW,0);
