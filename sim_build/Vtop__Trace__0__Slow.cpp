...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+80,0,"I2C_ADDRESS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 6,0);
    ...
    tracep->declBit(c+61,0,"out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+64,0,"counter_plus_1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+65,0,"register",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBit(c+66,0,"shift",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->pushPrefix("the_reg", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+81,0,"SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+81,0,"SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+82,0,"UNIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+72,0,"data_in",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 0,0);
    ...
    tracep->declBit(c+75,0,"clear",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+77,0,"out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBus(c+79,0,"counter",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop___024root__trace_const_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+80,(0x49U),7);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+64,(vlSelf->I2C_slave__DOT__the_piso__DOT__counter_plus_1),4);
    bufp->fullCData(oldp+65,(vlSelf->I2C_slave__DOT__the_piso__DOT__register),8);
    bufp->fullBit(oldp+66,(vlSelf->I2C_slave__DOT__the_piso__DOT__shift));
    bufp->fullCData(oldp+67,(vlSelf->I2C_slave__DOT__the_reg__DOT__in),8);
    bufp->fullCData(oldp+68,(vlSelf->I2C_slave__DOT__the_reg__DOT__out),8);
    bufp->fullBit(oldp+69,(vlSelf->I2C_slave__DOT__the_reg__DOT__clock));
    bufp->fullBit(oldp+70,(vlSelf->I2C_slave__DOT__the_reg__DOT__reset));
    bufp->fullBit(oldp+71,(vlSelf->I2C_slave__DOT__the_reg__DOT__enable));
    bufp->fullBit(oldp+72,(vlSelf->I2C_slave__DOT__the_sipo__DOT__data_in));
    bufp->fullBit(oldp+73,(vlSelf->I2C_slave__DOT__the_sipo__DOT__clock));
    bufp->fullBit(oldp+74,(vlSelf->I2C_slave__DOT__the_sipo__DOT__reset));
    bufp->fullBit(oldp+75,(vlSelf->I2C_slave__DOT__the_sipo__DOT__clear));
    bufp->fullBit(oldp+76,(vlSelf->I2C_slave__DOT__the_sipo__DOT__load));
    bufp->fullCData(oldp+77,(vlSelf->I2C_slave__DOT__the_sipo__DOT__out),8);
    bufp->fullBit(oldp+78,(vlSelf->I2C_slave__DOT__the_sipo__DOT__full));
    bufp->fullCData(oldp+79,(vlSelf->I2C_slave__DOT__the_sipo__DOT__counter),4);
}
